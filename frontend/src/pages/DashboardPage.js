...
import { MapPinned, Sun, ShoppingCart, Leaf, Users } from 'lucide-react'; // Added Users
    ...
    return (
        <Card>
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* New Button for Communaute */}
                <Button onClick={() => navigateTo('communauteCategories')} Icon={Users} className="w-full justify-start p-6 text-left bg-teal-50 hover:bg-teal-100 text-teal-700"><div className="ml-2"><p className="font-semibold">Communauté</p><p className="text-xs">Échanger avec d'autres agriculteurs</p></div></Button>
            </div>
        </Card>
    );
};
