...
const { authenticateToken } = require('../middleware/auth.middleware'); // Middleware pour protéger les routes
const { parcelleValidationRules, parcelleIdValidationRules, validate } = require('../middleware/validators/parcelle.validator');
