...
const { searchPrixValidationRules, addObservationValidationRules, validate } = require('../middleware/validators/prix.validator');

router.get('/observations', searchPrixValidationRules(), validate, prixController.searchPrixObservations);

router.post('/observations',
    authenticateToken,
    authorizeRole(['admin', 'collecteur']), // Seuls les admins ou collecteurs peuvent ajouter
    addObservationValidationRules(),
    validate,
    prixController.addPrixObservation
);
